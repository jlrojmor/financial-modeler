...
export default function DanaBuilder() {
  ...
  const isDanaLocked = useModelStore((s) => s.sectionLocks["dana"] ?? false);
  ...
  return (
    <CollapsibleSection
      sectionId="dana"
      title="Depreciation & Amortization (D&A)"
      description="Enter the total Depreciation & Amortization expense for each historical year. This represents the non-cash expense for the depreciation of fixed assets and amortization of intangible assets."
